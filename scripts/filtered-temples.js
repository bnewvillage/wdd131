...
const templeFigureSection = document.querySelector(`.templeFigures`);

function generateTempleCards(templeArray){
    templeFigureSection.innerHTML='';
    templeArray.forEach(temple => {
        ...
        templeFigureSection.appendChild(card);
    })
}
...
newLink.addEventListener(`click`, () => {
    templeFigureSection.innerHTML = '';
    generateTempleCards(temples.filter(temple => temple.dedicated.substring(0,4) > 2000));
})

oldLink.addEventListener(`click`, () => {
    templeFigureSection.innerHTML = '';
    generateTempleCards(temples.filter(temple => temple.dedicated.substring(0,4) < 1900));
})
